...
public class TestKieSession implements KieSession {
	private Map<String, TestProcessInstance> processInstances = new HashMap<String, TestProcessInstance>();
	...
	public ProcessInstance createProcessInstance(String arg0, Map<String, Object> arg1) {
		// TODO Auto-generated method stub
		return new TestProcessInstance();
	}

	public ProcessInstance getProcessInstance(long id) {
		TestProcessInstance processInstance = processInstances.get(id + "");
		if (processInstance == null) {
			processInstance = new TestProcessInstance();
			processInstances.put(id + "", processInstance);
		}
