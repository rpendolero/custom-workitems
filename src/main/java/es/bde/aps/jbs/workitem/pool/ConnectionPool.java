...
import es.bde.aps.jbs.workitem.util.DESEncrypter;
...
public class ConnectionPool extends GenericObjectPool {
	 ...
	 * @param namePool
	 */
	protected ConnectionPool(String namePool) throws JBSException {
	 ...
	 * 
	 */
	private DataSource createDataSource(String namePool) throws JBSException {
	...
	public Connection borrowObject() throws JBSException {
		// TODO Auto-generated method stub
		try {
			return (Connection) connectionFactory.makeObject();
		} catch (Exception e) {
			throw new JBSException("Error al obtener una conexion a la base de datos [" + e.getMessage() + "]");
		}
	}

	public void returnObject(Connection connection) throws JBSException {
		try {
			connectionFactory.destroyObject(connection);
		} catch (Exception e) {
			throw new JBSException("Error al devolver una conexion a la base de datos [" + e.getMessage() + "]");
		}
